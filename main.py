...
from otoco.otoco_tooling import OtocoTooling
...
def initialize_agent():
    ...
    otoco_toolkit = OtocoTooling.from_wrapper(agentkit)
    otoco_tools = otoco_toolkit.get_tools()

    tools = otoco_tools + cdp_tools
